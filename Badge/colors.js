const colors = [
 ...
 ['or', {value: '#ffee00', comp: '#000000'}],
 ['fer', {value: '#999999', comp: '#000000'}],
 ['azure', {value: '#0000ff', comp: '#ffffff'}],
 ['gules', {value: '#ff0000', comp: '#000000'}],
 ['sinople', {value: '#00cc44', comp: '#000000'}],
 ['purpure', {value: '#990099', comp: '#ffffff'}],
 ['orange', {value: '#ff7900', comp: '#000000'}],
 ['tenny', {value: '#886644', comp: '#ffffff'}],
 ['rose', {value: '#ffaabb', comp: '#000000'}],
 ['sky', {value: '#99bbff', comp: '#000000'}],
